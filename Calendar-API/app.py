...
# Reminder ENDPOINTS BELOW OK THANK YOU
...
def add_reminder():
    ...
    if existing_reminder_check is not None:
        return jsonify("Are you busy or something? You can only have set reminder per date!")
...
def update_reminder(month_id, date):
    if request.content_type != "application/json":
        return jsonify("Excuse me? How dare you.")
